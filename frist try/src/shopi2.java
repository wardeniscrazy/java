  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    Thread clock = new Thread(() -> {
      ...
      while (true) {
        ...
        System.out.printf("\r                                        Time: %02d:%02d%n", hour, minute);
    ...
    while (true) {
      ...
      System.out.println(  customer + " come to buy " + items[mobIndex][1]);
      System.out.println("Price: " + items[mobIndex][2] + "$");
      System.out.println("(catogry: " + (items[mobIndex][0]) + ")");
      System.out.println("");
