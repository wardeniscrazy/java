...
public class Dungeon_Loot_Explorer {
  public static void main(String[] args) {
    ...
    System.out.println("1.> attack monster[a]");
    ...
    while (true) {
      ...
      switch (rarity) {
        ...
        case "Uncommon":
          damage = rand.nextInt(5) + 3;
          break;

        case "Rare":
          damage = rand.nextInt(7) + 6;
          break;

        case "Epic":
          damage = rand.nextInt(9) + 10;
          break;

        case "Legendary":
          damage = rand.nextInt(11) + 15;
          break;

        case "Mythic":
          damage = rand.nextInt(16) + 25;
          break;
      }
      ...
      if (in.equals("a")) {
        ...
        System.out.println("You have " + player1Gold + " golds");
        System.out.println("player health after fight " + (player1Health - rn1));
        System.out.println("");
        System.out.println("");
        ...
        if (player1Health <= 0) {
          ...
          System.out.println("you earned itna gold: " + player1Gold);
          break;
      ...
      if (in.equals("s")) {
        System.out.println(player1Gold);

        System.out.println(player1Xp);
      }
    ...
    while (true) {
      ...
      if (in.equals("a")) {
        ...
        System.out.println("(Dropped Items: " + mon[mobIndex][2] + ")");
        System.out.println("Gold: " + mon[mobIndex][3]);
        System.out.println("You have " + player2Gold + " golds");
        System.out.println("player health after fight " + (player2Health - rn1));
        System.out.println("");
        System.out.println("");
        ...
        if (player2Health <= 0) {
          System.out.println("YOU ARE FINISHED 💥");
          System.out.println("you earned itna gold: " + player2Gold);
          break;
      ...
      if (in.equals("s")) {
        System.out.println(player2Gold);
        System.out.println(player2Xp);
      }
    }
